...
def get_identifier(name: str, delimiters: tuple[str, str] = ('.', '.')) -> tuple[str, str]:
    """
...
def copy_molecule(X: KappaMolecule, count=0, id_shift=0, system=None, signature=None, views=None, nav=True, canon=True) -> KappaMolecule:
    """
